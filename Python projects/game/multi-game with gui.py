...
class GuessingGame:
    ...
    def play(self):
        ...
        height = self.window.winfo_screenheight() // 2100
        ...
        self.button = tk.Button(self.window, text="Guess", command=self.check_guess, bg="lightblue")
        self.button.pack()

        self.hint_button = tk.Button(self.window, text="Hint", command=self.show_hint, bg="lightgreen")
        self.hint_button.pack()

        self.menu_button = tk.Button(self.window, text="Main Menu", command=self.return_to_menu, bg="orange")
...
class WordJumble:
    def __init__(self):
        self.words = ['python', 'jumble', 'easy', 'difficult', 'answer', 'xylophone', 'mastermind', 'heroku', 'occipital', 
                      'destroy', 'program', 'jumpstart', 'location', 'nasal', 'interface', 'lobotomy', 'quantum-physics']
...
class MultiGameProgram:
    def __init__(self):
        ...
        self.button1 = tk.Button(self.window, text="Guessing Game", command=self.play_guessing_game, bg="lightblue")
        self.button1.pack()

        self.button2 = tk.Button(self.window, text="Word Jumble", command=self.play_word_jumble, bg="lightgreen")
        self.button2.pack()

        self.button3 = tk.Button(self.window, text="Hangman", command=self.play_hangman, bg="orange")
        self.button3.pack()

        self.button4 = tk.Button(self.window, text="Number Mastermind", command=self.play_number_mastermind, bg="lightyellow")
        self.button4.pack()

        self.button5 = tk.Button(self.window, text="Exit", command=self.window.quit, bg="red")
        self.button5.pack()
